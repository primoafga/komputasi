                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                            <a href="" value="{{ $fld->ID_SISWA }}" class="EditBtn btn-primary btn-xs" data-toggle="modal" data-target="#EditModal" data-placement="top" title="Koreksi Data">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <div class="input-group input-group-sm">
                  <input type="text" name="NIS" id="eNIS"  class="form-control" placeholder="NIS" required>
                </div>
              </div>
  ...
  <script>
    ...
    $('.EditBtn').on('click',function() {
      ...
      if ($cID == "new") {
        ...
        $("#tJudul").text("Edit Data Siswa");
        $.get("Det_Sis/"+$(this).attr("value"))
          .done(function(data){
            $("#eNIS").val(data[0].NIS);
