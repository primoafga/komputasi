                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                            <a href="" value="{{ $fld->ID_KELAS }}" class="EditBtn btn-primary btn-xs" data-toggle="modal" data-target="#EditModal" data-placement="top" title="Koreksi Data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select name="GURU" class="form-control select2" id="eGURU" style="width: 100%;" >
                      ...
                      <option value="{{ $d->ID }}" >{{$d->NIG}} : {{ $d->NAMA }}</option>
                      @endforeach
                  </select>
                ...
                <div class="col-sm-10">
                  <div class="input-group input-group-sm">
                    <input type="text" name="TINGKAT" id="eTINGKAT"  class="form-control" placeholder="KETERANGAN">
                  </div>
                </div>
            </div>
          </div>
  ...
  <script>
    ...
    $('.EditBtn').on('click',function() {
      ...
      if ($cID == "new") {
        ...
        $("#tJudul").text("Edit Data KELAS");
        $.get("Det_Kel/"+$(this).attr("value"))
          .done(function(data){
            $("#eNAMA").val(data[0].NAMA);
            $("#eGURU").val(data[0].ID_WALI_KELAS);
            $("#eTINGKAT").val(data[0].TINGKAT);
            $cID = data[0].ID_KELAS;
          });
        }
