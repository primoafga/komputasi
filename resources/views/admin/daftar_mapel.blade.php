                  ...
                  <table id="findTable2" class="table table-sm">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ $fld->NAMA }} </td>
                        <td>{{ $fld->KETERANGAN }} </td>
                        <td class="text-center">
                            <a href="" value="{{ $fld->ID_MAPEL }}" class="EditBtn btn-primary btn-xs" data-toggle="modal" data-target="#EditModal" data-placement="top" title="Koreksi Data">
        ...
        <form class="form-horizontal" id="EditForm">
          ...
          <div class="modal-body">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <div class="input-group input-group-sm">
                    <input type="text" name="KETERANGAN" id="eKETERANGAN"  class="form-control" placeholder="KETERANGAN">
                  </div>
                </div>
            </div>
          </div>
...
@section('script_e')
  <script>
    ...
    $('.EditBtn').on('click',function() {
      $cID = $(this).attr("value");
      if ($cID == "new") {
        $("#tJudul").text("Add Data MAPEL");
        $("#eNAMA").val("");
        $("#eKETERANGAN").val("");
        }
      else {
        $("#tJudul").text("Edit Data MAPEL");
        $.get("Det_Map/"+$(this).attr("value"))
          .done(function(data){
            $("#eNAMA").val(data[0].NAMA);
            $("#eKETERANGAN").val(data[0].KETERANGAN);
            $cID = data[0].ID_MAPEL;
          });
        }
